		...
		<div class="clearfix user">
			...
			<div class="user_left">
				<div class="user_info">
					...
					<div style='color: #3089e7' class="user_name">${UserName}</div>
				</div>
				<ul class="Section">
			...
			<div class="user_right">
				<div class="user_Borders">
					...
					<c:forEach items="${FRUITS}" var="fruits">
						<form method="post" action="updateFruit" enctype="multipart/form-data">
							<div class="user_layout">
								<ul>
									
									<li><label class="user_title_name">水果名称:</label><input
										name="fName" type="text" class="add_text" id="fName"  value='${fruits.fName}' readonly="readonly"/>
										<div style="color:red;padding-left:80px;margin-top:5px;">*此处不能修改，姓名将作为修改依据*</div>
									</li>
										
									<li><label class="user_title_name">水果类型:</label><input
										name="fType" type="text" class="add_text" id="fType"  required="required"
										value="${fruits.fType}"
										/></li>
									<li><label class="user_title_name">水果产地:</label><input required="required"
										name="fPlace" type="text" class="add_text" onblur="checkPwd()" 
										value="${fruits.fPlace}"/>
									</li>
									<li><label class="user_title_name">简介:</label><input     required="required"
										name="introduction" type="text" class="add_text" value="${fruits.introduction}"
										onblur="checkRePwd()" /></li>
									<li><label class="user_title_name">价格:</label><input     required="required"
										name="fPrice" type="text" class="add_text" value="${fruits.fPrice}"
										onblur="checkRePwd()" /></li>
									<li><label class="user_title_name">数量:</label><input     required="required"
										name="fNumber" type="text" class="add_text" value="${fruits.fNumber}"
										onblur="checkRePwd()" /></li>
								</ul>
